...
Select.propTypes = {
	...
	onMenuScrollToTop: _propTypes2.default.func, // fires when the menu is scrolled to the top; can be used to paginate options
	...
	startOpen: _propTypes2.default.bool, // if true, select starts open
